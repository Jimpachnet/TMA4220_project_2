...
def generate_stiffness_matrix_paper(mesh):
    ...
    fracter = 1
    D_0 = np.array([[1, v, v, 0, 0, 0], [v, 1, v, 0, 0, 0], [v, v, 1, 0, 0, 0], [0, 0, 0, (1 - v) / fracter, 0, 0],
                    [0, 0, 0, 0, (1 - fracter) / 2, 0], [0, 0, 0, 0, 0, (1 - v) / fracter]])
    D_00 = np.array([[lame_lambda + 2 * mue, lame_lambda, lame_lambda, 0, 0, 0],
                     [lame_lambda, lame_lambda + 2 * mue, lame_lambda, 0, 0, 0],
                     [lame_lambda, lame_lambda, lame_lambda + 2 * mue, 0, 0, 0], [0, 0, 0, mue, 0, 0],
                     [0, 0, 0, 0, mue, 0], [0, 0, 0, 0, 0, mue]])
    # D = Youngs_E_Modulus / (1 - v ** 2) * D_0
